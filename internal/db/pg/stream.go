...
// batches. It is the PG equivalent of the mysql.StreamQuery helper; the
// only difference is that query must use $N positional placeholders (if
// any) and identifiers must be double-quoted.
